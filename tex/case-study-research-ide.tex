...
\todo {Fill this section in with some justification}

\begin{figure}[!ht]
\centering \includegraphics[width=4.0in]{./img/case-study-research-railgun/data-model}
