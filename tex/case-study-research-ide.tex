...
\todo{Discuss orthogonality of tag-like boolean permissions, ex. they don't support the requirement that a user be assigned either a view or view+edit permission, not both.}
