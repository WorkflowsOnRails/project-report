...
\item Many of the new third-party libraries were applied as well. aasm\_statecharts was applied to generate state machine diagrams from the implementation. These diagrams were used to validate that the implementation matched the design. aasm\_progressable was also used 
\end{itemize}
