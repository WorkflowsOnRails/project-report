...
To create the test suite, tests were generated using the input space partitioning black box testing methodology. Five key factors were identified that influence the behavior of the library:
...
After the characteristics and blocks were defined, test cases were generated according to the ``all blocks'' criterion. These test cases are presented in Table \ref{tbl:aasm-statecharts-cases}. These tests were then translated into unit tests using the RSpec testing library, and statement coverage reports were generated. Although the all-blocks criterion generally does not produce test suites with high levels of coverage, the implementation of aasm\_statecharts handles the parameters independently. This meant that 100\% test coverage was achievable without considering combinations of blocks.
