...
After completing the prototypes, a case study application was constructed based on Carleton University's fourth-year project management website. The case study application served two purposes: it allowed us to evaluate Stonepath in a real-world application instead of a contrived prototype, and also provided an opportunity to identify common workflow-related functionality that is not provided by existing Rails libraries.
